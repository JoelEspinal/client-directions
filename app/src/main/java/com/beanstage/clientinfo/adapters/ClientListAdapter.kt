...
class ClientListAdapter : ListAdapter<Client, ClientListAdapter.ClientViewHolder>(CLIENT_COMPARATOR) {
    ...
    class ClientViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val clientNameTextView: TextView = itemView.findViewById(R.id.client_name_textview)
        private val socialReason: TextView = itemView.findViewById(R.id.social_reason_textview)
        private val agentNameTextView: TextView = itemView.findViewById(R.id.agent_name_textview)
